...
ex2_trials <- do.call(rbind, trials)
ex2_questions <- do.call(rbind, questions)


episodic_data <- fload("C:\\Users\\beera\\Downloads\\Thesis\\ex2_JSON_files\\data__2023-03-29T20_23_42.654Z_.json")
